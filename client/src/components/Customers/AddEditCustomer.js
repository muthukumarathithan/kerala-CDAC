...
//redux
import { createCustomer, getCurrentCustomer, updateCustomer} from '../../store/actions/customers';
...
class AddEditCustomer extends Component {
        ...
        try {
            ...
            if(this.props.location.pathname.includes("new"))
             this.setState({page : 'ADD'})
               ...
               await getCurrentCustomer(this.props.match.params.id);
    ...
    addCustomer = (event) =>{
      if(this.state.page === 'ADD')
        this.props.createCustomer(this.state, this.props.history);
         ...
         this.props.updateCustomer(this.props.match.params.id, this.state, this.props.history); 
 ...
 >CLEAR</Button>
          ...
          <Button variant="contained" color="secondary" onClick={this.addCustomer}>{this.state.page} CUSTOMER</Button>
        </Grid>
...
export default connect (store =>({customer:store.currentCustomer}), { getCurrentCustomer, createCustomer, updateCustomer } )(AddEditCustomer);
